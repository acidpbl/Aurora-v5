...
export function HeaderRoot({ children }: HeaderRootProps) {
  ...
  return (
    <header className="w-full h-16 rounded-lg bg-card border-2 border-tertiary flex items-center p-4 justify-between ease-linear transition-colors lowercase">
